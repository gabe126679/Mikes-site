    ...
    <>
      ...
      <div className="carousel">
        <Carousel breakPoints={breakPoints}>
          ...
          <Item><img src={img2} alt="img"/></Item>
          <Item><img src={img3} alt="img"/></Item>
          <Item><img src={img4} alt="img"/></Item>
          <Item><img src={img5} alt="img"/></Item>
          <Item><img src={img6} alt="img"/></Item>
          <Item><img src={img7} alt="img"/></Item>
          <Item><img src={img8} alt="img"/></Item>
        </Carousel>
      </div>
    </>
  )
