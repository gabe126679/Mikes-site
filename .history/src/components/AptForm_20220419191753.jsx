  ...
  return (
    ...
    <div className="container-email">
          <div  className="container border">
            ...
            <p className="text-center w-responsive mx-auto mb-5">Select a Date and Time that is most suitable for us to have a chat. We look forward to hearing from you!</p>
            </div>
              <p> From: </p>
              ...
              <p> To: (optional)</p>
                ...
                <form id="contact-form" name="contact-form" action="mail.php" method="POST">
                    ...
                    <div className="text-center text-md-left d-flex justify-content-center">
                        <input className="btn" type="submit" to="/">Send</input>
                    </div>
                    <br/>
                    <br/>
                </form>
