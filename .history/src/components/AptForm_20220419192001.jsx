  ...
  return (
    ...
    <div className="container-email">
          <div  className="container border">
            ...
            <p className="text-center w-responsive mx-auto mb-5" style={"color: blue"}>Select a Date and Time that is most suitable for us to have a chat. We look forward to hearing from you!</p>
            </div>
              <p> From: </p>
